...
int size = FromStringToInt("Задайте размер массива (число элементов): ");
int minValue = FromStringToInt("Укажите минимальное значение массива: ");
int maxValue = FromStringToInt("Укажите максимальное значение массива: ");
